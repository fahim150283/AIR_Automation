Feature: Store Type Test for BPU
  ...
  Scenario: Edit a Store_type with status active and visibility active
    Given login to Search for Store_type

  Scenario: Edit a Store_type with status active and visibility inactive
    Given login to Search for Store_type
  ...
  Scenario: Edit a Store_type with status inactive and visibility active
    Given login to Search for Store_type
  ...
  Scenario: Edit a Store_type with status inactive and visibility inactive
    Given login to Search for Store_type
